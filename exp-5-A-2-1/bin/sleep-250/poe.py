...
def get_pipeline(tasks):
    ...
    for cnt in range(tasks):
        ...
        t1.arguments = [app_coll[app_name]['arguments'] * sleep_time]
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 4:
        print 'Missing arguments. Execution cmd: python poe.py <num_tasks> <sleep_time> <resource_name>'
        sys.exit(1)
