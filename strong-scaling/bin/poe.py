...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 3:
        print 'Missing arguments. Execution cmd: python poe.py <num_tasks> <resource_name>'
        sys.exit(1)
    ...
    pipes_set.add(get_pipeline(1024))

    pilot_cores = num_cores + 1
