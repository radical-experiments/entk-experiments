...
initial_config <- function (verbose = F) {
  ...
  file.forecast <- '/work/vivek91/Temperature_NAM/Forecasts_NAM_C.nc'
  file.observation <- '/work/vivek91/Temperature_NAM/Analysis_NAM_R.nc'
  ...
  output.prefix <- paste('/work/vivek91/', current_stage, '_', sep = '')
